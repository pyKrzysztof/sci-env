...
def get_defaults():
	...
	config['General'] = {'themes_path': 'themes/',
						 'SaveWidgetsOnExit': 'no',
						 'Theme': 'DefaultDark'}
	config['Small Font'] = {'Size': 13, 'Family': 76, 'Style': 90, 'Weight': 90}
	config['Medium Font'] = {'Size': 17, 'Family': 76, 'Style': 90, 'Weight': 90}
	config['Large Font'] = {'Size': 26, 'Family': 76, 'Style': 90, 'Weight': 92}
	return config
