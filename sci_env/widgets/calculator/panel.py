...
from widgets.calculator.expression_manager import evaluate
from decimal import *
...
class Panel(wx.Panel):
	...
	def __init__(self, parent, appConf):
		...
		self.font = appConf.Get('regFont', True)
		self.bigFont = appConf.Get('regFont', True)
		self.bigFont.SetPointSize(20)
		self.fontSize = 14
	...
	def DefineStyles(self):
		self.REGULAR_STYLE = wx.TextAttr(self.appConf.Get('widgetTextColor'), self.appConf.Get('widgetColor1'))
	...
	def Display(self):
		...
		self.hist = History(self, style=wx.NO_BORDER|wx.TE_RICH2|wx.TE_READONLY, size=(100, 80))
		self.hist.SetFont(self.bigFont)
		self.hist.SetBackgroundColour(self.appConf.Get('widgetColor1'))
		self.hist.SetDefaultStyle(self.REGULAR_STYLE)

		self.inp = Input(self, self.appConf.Get('widgetColor1'))
		self.inp.SetFont(self.font)
		self.inp.SetForegroundColour(self.appConf.Get('widgetTextColor'))
